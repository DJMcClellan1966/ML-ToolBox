"""AI Concepts Lab  Game theory, search & planning, reinforcement learning, probabilistic reasoning. Run from repo root: python learning_apps/ai_concepts_lab/app.py"""
import sys
...
app = create_lab_app(
    ...
    description="Game theory, search & planning, reinforcement learning, probabilistic reasoning (Russell & Norvig style).",
    port=5004,
    lab_id="ai_concepts_lab",
    curriculum_module=curriculum_module,
    demos_module=demos_module
)

if __name__ == "__main__":
    print(f"AI Concepts Lab  http://127.0.0.1:5004/")
