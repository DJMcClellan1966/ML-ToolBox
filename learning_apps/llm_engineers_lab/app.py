...
for p in (str(REPO_ROOT), str(LAB_DIR)):
    if p not in sys.path:
        sys.path.insert(0, p)
APP_TITLE = "LLM Engineers Lab"
APP_DESCRIPTION = "Machine Learning / LLM Engineers Handbook (RAG, prompts, eval, safety) + Build Your Own LLM (architecture, training, apps)."
try:
