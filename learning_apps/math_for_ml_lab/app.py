...
app = create_lab_app(
    title="Math for ML Lab",
    description="Basic math for machine learning: linear algebra, calculus, probability & statistics, optimization.",
    port=5013,
    lab_id="math_for_ml_lab",
    curriculum_module=curriculum_module,
    demos_module=demos_module
)

if __name__ == "__main__":
    print(f"Math for ML Lab  http://127.0.0.1:5013/")
