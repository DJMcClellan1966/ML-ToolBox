"""Math for ML Lab — Basic math for machine learning. Run from repo root: python learning_apps/math_for_ml_lab/app.py"""
import sys
...
for p in (str(REPO_ROOT), str(LAB_DIR)):
    if p not in sys.path:
        sys.path.insert(0, p)
APP_TITLE = "Math for ML Lab"
APP_DESCRIPTION = "Basic math for machine learning: linear algebra, calculus, probability & statistics, optimization."
try:
