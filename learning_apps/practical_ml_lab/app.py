"""Practical ML Lab  Hands-On Machine Learning (Geron). Run from repo root: python learning_apps/practical_ml_lab/app.py"""
import sys
...
app = create_lab_app(
    title="Practical ML Lab",
    description="Hands-On Machine Learning (Geron): feature engineering, model selection, tuning, ensembles, cross-validation, production.",
    port=5008,
    lab_id="practical_ml_lab",
    curriculum_module=curriculum_module,
    demos_module=demos_module
)

if __name__ == "__main__":
    print(f"Practical ML Lab  http://127.0.0.1:5008/")
