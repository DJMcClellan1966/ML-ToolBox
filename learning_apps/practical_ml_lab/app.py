"""Practical ML Lab — Hands-On ML (Géron). Run from repo root: python learning_apps/practical_ml_lab/app.py"""
import sys
...
for p in (str(REPO_ROOT), str(LAB_DIR)):
    if p not in sys.path:
        sys.path.insert(0, p)
APP_TITLE = "Practical ML Lab"
APP_DESCRIPTION = "Hands-On Machine Learning (Géron): feature engineering, model selection, tuning, ensembles, cross-validation, production."
try:
