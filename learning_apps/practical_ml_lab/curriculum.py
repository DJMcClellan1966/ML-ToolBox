...
CURRICULUM: List[Dict[str, Any]] = [
    ...
    {"id": "model_select", "book_id": "model_selection", "level": "basics", "title": "Model Selection",
     ...
     "try_demo": "practical_model_select"},
