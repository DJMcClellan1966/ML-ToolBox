"""CLRS Algorithms Lab  Introduction to Algorithms: DP, Greedy, Graph. Run from repo root: python learning_apps/clrs_algorithms_lab/app.py"""
import sys
...
app = create_lab_app(
    title="CLRS Algorithms Lab",
    description="Introduction to Algorithms: DP, Greedy, Graph. Learn and run demos.",
    port=5002,
    lab_id="clrs_algorithms_lab",
    curriculum_module=curriculum_module,
    demos_module=demos_module
)

if __name__ == "__main__":
    print(f"CLRS Algorithms Lab  http://127.0.0.1:5002/")
