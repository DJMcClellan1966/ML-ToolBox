"""
Enrich RL Lab - Reinforcement Learning
======================================

Generates curriculum items for RL Lab covering Sutton & Barto.
"""
...
def generate_rl_curriculum():
    """Generate RL curriculum items covering modern RL."""
...
def main():
    print("=" * 70)
    print("RL LAB ENRICHMENT")
    print("=" * 70)
    print()
    
    items = generate_rl_curriculum()
    ...
    output_file = output_dir / "rl_enriched.json"
    ...
    print(f"Target achieved: 20 items covering Sutton & Barto")
    print(f"\nTopics:")
    print(f"  • MDPs & Value Functions (basics)")
    print(f"  • Dynamic Programming & TD Learning (intermediate)")
    print(f"  • Deep RL (DQN, Policy Gradient, Actor-Critic) (advanced)")
    print(f"  • PPO, Model-Based RL (expert)")
