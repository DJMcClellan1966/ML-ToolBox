"""RL Lab  Sutton & Barto: MDPs, value functions, TD, Q-learning, policy gradient. Run from repo root: python learning_apps/rl_lab/app.py"""
import sys
...
app = create_lab_app(
    title="RL Lab",
    description="Sutton & Barto: MDPs, value functions, TD, Q-learning, policy gradient.",
    port=5009,
    lab_id="rl_lab",
...
if __name__ == "__main__":
    print(f"RL Lab  http://127.0.0.1:5009/")
