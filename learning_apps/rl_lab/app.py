"""RL Lab — Sutton & Barto, Reinforcement Learning: An Introduction. Run from repo root: python learning_apps/rl_lab/app.py"""
import sys
...
for p in (str(REPO_ROOT), str(LAB_DIR)):
    if p not in sys.path:
        sys.path.insert(0, p)
APP_TITLE = "RL Lab"
APP_DESCRIPTION = "Sutton & Barto: MDPs, value functions, TD, Q-learning, policy gradient."
try:
