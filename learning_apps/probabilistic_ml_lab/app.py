"""Probabilistic ML Lab — Murphy, A Probabilistic Perspective. Run from repo root: python learning_apps/probabilistic_ml_lab/app.py"""
import sys
...
for p in (str(REPO_ROOT), str(LAB_DIR)):
    if p not in sys.path:
        sys.path.insert(0, p)
APP_TITLE = "Probabilistic ML Lab"
APP_DESCRIPTION = "Murphy: graphical models, EM, variational inference, Bayesian learning."
try:
