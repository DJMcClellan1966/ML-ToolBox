...
BOOKS = [
    ...
    {"id": "mcmc", "name": "MCMC Sampling", "short": "MCMC", "color": "#d97706"},
]
...
CURRICULUM: List[Dict[str, Any]] = [
    ...
    # MCMC SAMPLING (1 item - HMC)
    {"id": "hmc", "book_id": "mcmc", "level": "expert", "title": "Hamiltonian Monte Carlo",
