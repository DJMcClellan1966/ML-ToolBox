"""SICP Lab — Abelson, Sussman, Sussman. Run from repo root: python learning_apps/sicp_lab/app.py"""
import sys
...
for p in (str(REPO_ROOT), str(LAB_DIR)):
    if p not in sys.path:
        sys.path.insert(0, p)
APP_TITLE = "SICP Lab"
APP_DESCRIPTION = "Structure and Interpretation of Computer Programs: functional pipeline, streams, data abstraction, symbolic computation."
try:
