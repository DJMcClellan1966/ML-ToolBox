"""ML Theory Lab — Shalev-Shwartz & Ben-David, Understanding Machine Learning. Run from repo root: python learning_apps/ml_theory_lab/app.py"""
import sys
...
for p in (str(REPO_ROOT), str(LAB_DIR)):
    if p not in sys.path:
        sys.path.insert(0, p)
APP_TITLE = "ML Theory Lab"
APP_DESCRIPTION = "Understanding Machine Learning (Shalev-Shwartz & Ben-David): PAC, VC dimension, generalization, stability, Rademacher."
try:
