"""Python Practice Lab  Reed & Zelle: problem decomposition, algorithm patterns, data structures. Run from repo root: python learning_apps/python_practice_lab/app.py"""
import sys
...
app = create_lab_app(
    ...
    description="Reed & Zelle: problem decomposition, algorithm patterns, data structures, code organization.",
    port=5006,
    lab_id="python_practice_lab",
    curriculum_module=curriculum_module,
    demos_module=demos_module
)

if __name__ == "__main__":
    print(f"Python Practice Lab  http://127.0.0.1:5006/")
